...
-- CreateIndex
CREATE UNIQUE INDEX "stripe_payment_intents_paymentId_key" ON "stripe_payment_intents"("paymentId");

-- CreateIndex
CREATE UNIQUE INDEX "stripe_payment_intents_stripePaymentIntentId_key" ON "stripe_payment_intents"("stripePaymentIntentId");

-- CreateIndex
CREATE INDEX "stripe_payment_intents_stripePaymentIntentId_idx" ON "stripe_payment_intents"("stripePaymentIntentId");
...
-- AddForeignKey
ALTER TABLE "stripe_payment_intents" ADD CONSTRAINT "stripe_payment_intents_paymentId_fkey" FOREIGN KEY ("paymentId") REFERENCES "payments"("id") ON DELETE CASCADE ON UPDATE CASCADE;
